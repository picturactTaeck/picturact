<nav class="navbar main_navy_style" role="navigation">
		<div class="container">
			<!-- Brand and toggle get grouped for better mobile display -->
			<div class="col-xs-2 col-lg-1" style="min-width: 100px">
...
<!-- 						class="icon-bar"></span> -->
<!-- 				</button> -->
				<a class="navbar-brand picturact_logo" href="/">picturact</a>
			</div>
...
<!-- 					<li><a href="/logout.main">Logout</a></li> -->
				...
				<ul class="main_navy_style_text_color navbar_textrightflow ">
		        	...
		        	<li><a id="friend_nav" href="http://www.naver.com"><i class="glyphicon glyphicon-user" aria-hidden="true"></i></a></li>
		      	</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
