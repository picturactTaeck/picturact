...
<!-- 모달 팝업 -->
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	  <div class="modal-dialog">
		...
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">x×X</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">Your Location</h4>
	      </div>
	      <div class="modal-body">
<!-- 			Location : <input type="text" placeholder="Where you at..?"> -->
			Location :<%@ include file="../map/google.jsp"%>
